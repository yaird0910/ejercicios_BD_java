...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_venta`(in Folio int,in Codigo_Libro int,in Codigo_Cliente int,in Fecha_venta date, in Nombre_cliente varchar(50),in Nombre_Empleado varchar(50),in Total_Compra int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `surtir`(in Folio int,in Codigo_Libro int,in rfc varchar(50),in fecha_surtido date,in nombre_proveedor varchar(50),in nombre_supervisor varchar(50),cantidad int)
BEGIN
...
-- Dump completed on 2014-12-03 13:13:56
